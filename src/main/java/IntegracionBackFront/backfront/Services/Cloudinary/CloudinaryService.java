...
public class CloudinaryService {
    ...
    private static  final long MAX_FILE_SIZE = 5 * 1044 * 1024;
    ...
    private void validateImage(MultipartFile file) {
        ...
        //2. Verificar i el tamañ es adecuado
        ...
        if(!Arrays.asList(ALLOWERD_EXTENSIONS).contains(extension)){
            throw new IllegalArgumentException("solo se perimten archivos JPG, JPEG, PNG");
        }
